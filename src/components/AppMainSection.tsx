    ...
    return ( 
      <main>    
        <PlaceEntry 
          ...
          <PlaceEntry 
          title={"Home Town 2"}
          imageURL={"https://upload.wikimedia.org/wikipedia/commons/thumb/4/4d/Jaflong_Sylhet.jpg/800px-Jaflong_Sylhet.jpg"}
          placeName = {'Sylhet'}
          countryName = {'Bangladesh'}
          location = {'https://www.google.com/maps?q=sylhet&source=lmns&bih=784&biw=1919&hl=en&sa=X&ved=2ahUKEwjQo7Dimf34AhXNhFwKHaY0BicQ_AUoAXoECAEQAQ'}    
          reason = {`It's where my parents were born and where they grew up!`}
          />
          <PlaceEntry 
          title={"Home Town"}
          imageURL={"https://a.cdn-hotels.com/gdcs/production114/d1461/2267d2c2-21e8-4964-bed0-f5bb480def60.jpg?impolicy=fcrop&w=800&h=533&q=medium"}          
